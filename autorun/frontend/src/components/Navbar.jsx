...
import ClienteNew from '../views/ClienteNew';
import EditCliente from '../views/EditCliente'
import SeguimientoCliente from '../views/SeguimientoClienteView'
import PlanClienteNew from '../views/PlanClienteNew'
...
function Navbar() {
    ...
    //         <a href="/dashboard" className="d-flex align-items-start mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
    //             {/* <img src="/uploads/isotipo.png" alt="" className='w-50' /> */}
    //             {/* <span className="fs-4">MasAuto</span> */}
    //             <img src="/uploads/imagotipo-masauto-negativo.png" alt="" className='w-100' />
    //         </a>
    ...
    <>
        ...
        {token && (
            <button 
                className="btn btn-primary m-3 position-fixed"
                style={{ zIndex: 1050 }}
        ...
        {token && (
            <div 
                className={`d-flex flex-column flex-shrink-0 p-3 bg-primary ${!sidebarOpen ? 'd-none' : ''}`}
                style={{ width: '280px', height: '100vh' }}
            >
                {/* Encabezado del Sidebar */}
                <a href="/dashboard" className="d-flex align-items-start mt-5 mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                    {/* <img src="/uploads/isotipo.png" alt="" className='w-50' /> */}
                    {/* <span className="fs-4">MasAuto</span> */}
        ...
        <Routes>
            ...
            <Route path='/clientes' element={<PrivateRoute> <Clientes /></PrivateRoute>} />
                ...
                <PrivateRoute><ClienteNew /></PrivateRoute>
                } />

            <Route path='/actualizarCliente/:id' element={<PrivateRoute><EditCliente /></PrivateRoute>} />
            
                        <Route path='/seguimientoCliente/:id' element={<PrivateRoute><SeguimientoCliente /></PrivateRoute>} />
                                        <Route path='/nuevoPlan/:id' element={<PrivateRoute><PlanClienteNew /></PrivateRoute>} />
